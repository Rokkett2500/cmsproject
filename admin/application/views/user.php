                    ...
                    <tbody>
                      <?php foreach ($user as $st) : ?>
                        <tr>
                          ...
                          <td><?= $st->level ?></td>
                          <td>
                            <form action="<?= site_url('edituser/' . $st->id_user); ?>" method="post">
                              <input type="hidden" value="<?= $st->id_user ?>" name="uid">
                              <button class="btn btn-primary btn-sm" type="submit">Edit</button>
                            </form>
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal<?= $st->id_user ?>">
                              Delete
                            </button>
                          </td>
                        </tr>
                        <div class="modal fade" id="deleteModal<?= $st->id_user ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <form action="<?= site_url('deleteuseract'); ?>" method="post">
                                  <input type="hidden" value="<?= $st->id_user ?>" name="sid">
