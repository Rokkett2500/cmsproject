    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          </form> <a href="<?= site_url('addgallery') ?>">
            <button class="btn btn-primary mb-2"> Add Gallery Item</button>
          </a>
            ...
            <?php foreach ($user as $st) : ?>
              <div class="col">
                <div class="card" style="width: 18rem;">
                  <img class="card-img-top" src="<?= base_url('assets/files/gallery/') ?><?= $st->image ?>" alt="Error">
                  <div class="card-body">
                    <h5 class="card-title"><?= $st->gallery_name ?></h5>
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal<?= $st->id ?>">
                      Delete
                    </button>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <form action="<?= site_url('deletegalleryact'); ?>" method="post">
