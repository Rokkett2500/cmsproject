          ...
          <div class="col grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form class="forms-sample" method="post" action="<?= site_url('editcategoryact') ?>">
                  <div class="form-group row">
                    <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Category</label>
                    <div class="col-sm-9">
                    <input type="hidden" value="<?= $userd['0']['category_id'] ?>" name="uid">
                      <input type="text" value="<?= $userd['0']['category'] ?>" class="form-control" id="exampleInputUsername2" placeholder="Category name" name="category">
                    </div>
                  </div>
                  <input type="submit" class="btn btn-primary mr-2" value="Edit">
                  </form> <a href="<?= site_url('category') ?>">
