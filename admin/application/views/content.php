    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <a href="<?= site_url('addcontent') ?>">
            <button class="btn btn-primary mb-2"> Add Content</button>
          </a>
                    ...
                    <tbody>
                      <?php foreach ($user as $st) : ?>
                        <tr>
                          ...
                          <td><?= $st['date'] ?></td>
                          <td>
                            <a href="<?= base_url('assets/files/content/') ?><?= $st['image'] ?>">
                              <button class="btn btn-primary btn-sm">View Image</button>
                            </a>
                          </td>
                          <td>
                            <form action="<?= site_url('editcontent/' . $st['content_id']); ?>" method="post">
                              <input type="hidden" value="<?= $st['content_id'] ?>" name="uid">
                              <button class="btn btn-primary btn-sm" type="submit">Edit</button>
                            </form>
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal<?= $st['content_id'] ?>">
                              Delete
                            </button>
                          </td>
                        </tr>

                        <div class="modal fade" id="exampleModal<?= $st['content_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <form action="<?= site_url('deletecontentact'); ?>" method="post">
                                  <input type="hidden" value="<?= $st['content_id'] ?>" name="sid">
