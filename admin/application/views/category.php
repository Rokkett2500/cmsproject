    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          </form> <a href="<?= site_url('addcategory') ?>">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $st->category ?></td>
                          <td>
                            <form action="<?= site_url('editcategory/' . $st->category_id); ?>" method="post">
                              <input type="hidden" value="<?= $st->category_id ?>" name="uid">
                              <button class="btn btn-primary btn-sm" type="submit">Edit</button>
                            </form>
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal<?= $st->category_id ?>">
                              Delete
                            </button>
                            <div class="modal fade" id="exampleModal<?= $st->category_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <form action="<?= site_url('deletecategoryact'); ?>" method="post">
                                      <input type="hidden" value="<?= $st->category_id ?>" name="sid">
