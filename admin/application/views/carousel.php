    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          </form> <a href="<?= site_url('addcarousel') ?>">
            <button class="btn btn-primary mb-2"> Add Carousel Items</button>
          </a>
            ...
            <?php foreach ($user as $st) : ?>
              <div class="col">
                <div class="card" style="width: 18rem;">
                  <img class="card-img-top" src="<?= base_url('assets/files/carousel/') ?><?= $st->image ?>" alt="Error">
                  <div class="card-body">
                    <h5 class="card-title"><?= $st->title ?></h5>
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal<?= $st->carousel_id ?>">
                      Delete
                    </button>
                    <div class="modal fade" id="exampleModal<?= $st->carousel_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                           ...
                           <form action="<?= site_url('deletecarouselact'); ?>" method="post">
                                  <input type="hidden" value="<?= $st->carousel_id ?>" name="sid">
