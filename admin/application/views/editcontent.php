          ...
          <div class="col grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form class="forms-sample" method="post" action="<?= site_url('editcontentact') ?>" enctype="multipart/form-data">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Title</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="title"  value="<?= $userd['0']['title'] ?>">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <textarea class="form-control" name="content_details"><?= $userd['0']['content_details'] ?></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <input type="hidden" value="<?= $userd['0']['content_id'] ?>" name="uid">
                  <input type="submit" class="btn btn-primary mr-2" value="Edit">
                  </form> <a href="<?= site_url('content') ?>">
